...
function SharePanel({ walletId, score, endorsements }: { walletId: number; score: number; endorsements: number }) {
  ...
  return (
    <div ref={panelRef} className="relative">
      <div className="absolute inset-0 bg-gradient-to-r from-[var(--forest)] via-[var(--sage)] to-[var(--amber-sap)] rounded-2xl blur-xl opacity-20 animate-pulse" style={{ animationDuration: "4s" }} />
      ...
      <div className="relative card-botanical rounded-2xl overflow-hidden">
        ...
        <div className="p-5 sm:p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <div>
              <p className="text-base font-heading font-bold text-[var(--dark-ink)]">Share Profile</p>
              <p className="text-[11px] text-[var(--stone)]">Anyone can view this reputation</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-5 sm:gap-6">
              ...
              <div className="relative p-3 rounded-xl bg-white border border-[var(--faded-sage)] shadow-[inset_0_2px_8px_rgba(0,0,0,0.04)]">
                {isGeneratingQr ? (
                  <div className="w-[140px] h-[140px] flex items-center justify-center">
                    <div className="h-8 w-8 rounded-full border-2 border-[var(--forest)] border-t-transparent animate-spin" />
                  </div>
                ) : qrDataUrl ? (
                  <Image src={qrDataUrl} alt="QR Code" width={140} height={140} className="rounded-lg" unoptimized />
                ) : (
                  <div className="w-[140px] h-[140px] flex items-center justify-center text-[var(--stone)] text-xs text-center p-4">
                    QR unavailable
                  </div>
                )}
            ...
            <div className="flex-1 space-y-4">
              <div className="bg-[var(--parchment)] rounded-xl p-4 border border-[var(--faded-sage)]">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-[10px] font-mono-data uppercase tracking-wider text-[var(--stone)]">Profile Link</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={handleCopy}
                  className="group relative flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-[var(--faded-sage)] bg-white text-sm font-semibold text-[var(--dark-ink)] hover:bg-[var(--forest)]/5 hover:border-[var(--forest)]/30 transition-all cursor-pointer overflow-hidden"
                >
                  <div className={`absolute inset-0 bg-[var(--forest)]/10 transition-opacity ${copied ? "opacity-100" : "opacity-0"}`} />
                  <span className="relative flex items-center gap-2">
                    {copied ? (
                      <>
                        <svg className="w-4 h-4 text-[var(--forest)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button
                  ...
                  className="group relative flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#1DA1F2] text-white text-sm font-semibold hover:bg-[#1a91da] transition-all cursor-pointer overflow-hidden"
                  style={{
              ...
              <div className="flex items-center justify-center gap-3 pt-2">
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[var(--parchment)] border border-[var(--faded-sage)]">
        ...
        <div className="border-t border-[var(--faded-sage)]/50 px-5 py-3 bg-[var(--warm-cream)]/30">
