...
export const WALLET_OPTIONS: WalletOption[] = [
  ...
  },
  {
    ...
    description: "Connect via QR code from your LOBSTR mobile app.",
    capability: "limited",
    supportLabel: "Login supported",
    helperText: "Scan the QR code with your LOBSTR mobile app to connect. Transactions are signed via push notification on your phone.",
    signSupportLabel: "Mobile signing",
    icon: "LB",
    accent: "var(--stone)",
